...
export default function DashboardCard(){
    ...
    return (
        <div className="flex flex-col justify-center items-end bg-accent-color-darkgreen p-4 rounded-xl">
            <Link to={'/generate-idea'} aria-label="button redirecting to generate idea page">
            ...
            <Link to={'/add-idea'} aria-label="button redirecting to add idea page" >
            ...
            <Link to={'/date-list'} aria-label="button redirecting to date list page">
